...
与虚拟宠物「咕咕嘎嘎」互动，倾诉求职烦恼，获得情感支持和鼓励。咕咕嘎嘎是一只软乎乎圆滚滚的帝企鹅宝宝，也是你的专属小小管理员，会用软萌的方式陪伴你度过求职路上的每一天。
...
- ✅ 优化AI对话响应速度（maxTokens: 500→300, timeoutMs: 15000→10000）
- ✅ 更新宠物人设为「咕咕嘎嘎管理员企鹅」，更完整的人物设定
- ✅ 配置腾讯混元大模型作为备用AI服务
- ✅ 实现流式响应UI显示，边生成边显示，提升用户体验
- ✅ 修复AI配置加载时topK字段类型错误
