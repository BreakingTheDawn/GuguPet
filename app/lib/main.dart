        ...
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          return ListenableBuilder(
            ...
            builder: (context, child) {
              // 获取当前用户ID
              final currentUserId =
                  _authProvider.currentUser?.userId ?? 'guest_user';
              ...
              return MultiProvider(
                providers: [
                  ...
                  ChangeNotifierProvider<ParkProvider>.value(
                    value: _parkProvider,
                  ),
                  ...
                  // 添加全局ConfideProvider
                  ChangeNotifierProvider<ConfideProvider>.value(
                    value: serviceProvider.confideProvider,
                  ),
                ],
                child: MaterialApp(
                  title: '职宠小窝',
